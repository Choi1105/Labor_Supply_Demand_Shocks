...
file = strcat("C:/Users/KYM/Desktop/Git/nopasanada/Data/NAICS2/All/", sector, "_data.csv");
end

%if subsectors == 0 && production == 1
%file = strcat("C:/Users/KYM/Desktop/Git/nopasanada/Data/NAICS2/Production_only/", sector, "_data.csv");
%end
%if subsectors == 1
%file = strcat("C:/Users/KYM/Desktop/Git/nopasanada/Data/NAICS3/", sector, "_data.csv");
%end
...
tstart = 5;    % start estimation with 2011:M05

if subsectors == 0
    tend = size(yall,1)-3;    % end estimation with 2020:M02
    YY = yall(tstart:tend,:);
    date_start = 2011+5/12;
